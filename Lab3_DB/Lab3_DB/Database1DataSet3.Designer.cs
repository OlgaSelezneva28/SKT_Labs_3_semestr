...
namespace Lab3_DB {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class ПерсоналDataTable : global::System.Data.TypedTableBase<ПерсоналRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ПерсоналRow AddПерсоналRow(int Код_сотрудника, string ФИО, int Код_отделения, System.DateTime Дата_рождения, string Телефон, string Должность, decimal Оклад) {
        ...
        public partial class ПерсоналRow : global::System.Data.DataRow {
            ...
            public int Код_отделения {
                get {
                    return ((int)(this[this.tableПерсонал.Код_отделенияColumn]));
                }
                set {
                    this[this.tableПерсонал.Код_отделенияColumn] = value;
                }
            }
            ...
            public decimal Оклад {
                get {
                    try {
                        return ((decimal)(this[this.tableПерсонал.ОкладColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsОкладNull() {
                return this.IsNull(this.tableПерсонал.ОкладColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetОкладNull() {
                this[this.tableПерсонал.ОкладColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Lab3_DB.Database1DataSet3TableAdapters {
    ...
    public partial class ПерсоналTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Персонал] WHERE (([Код сотрудника] = @Original_Код_сотрудника) AND ([ФИО] = @Original_ФИО) AND ([Код отделения] = @Original_Код_отделения) AND ([Дата рождения] = @Original_Дата_рождения) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ([Должность] = @Original_Должность) AND ((@IsNull_Оклад = 1 AND [Оклад] IS NULL) OR ([Оклад] = @Original_Оклад)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Персонал] ([Код сотрудника], [ФИО], [Код отделения], [Дата рождения], [Телефон], [Должность], [Оклад]) VALUES (@Код_сотрудника, @ФИО, @Код_отделения, @Дата_рождения, @Телефон, @Должность, @Оклад);
SELECT [Код сотрудника], ФИО, [Код отделения], [Дата рождения], Телефон, Должность, Оклад FROM Персонал WHERE ([Код сотрудника] = @Код_сотрудника)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Персонал] SET [Код сотрудника] = @Код_сотрудника, [ФИО] = @ФИО, [Код отделения] = @Код_отделения, [Дата рождения] = @Дата_рождения, [Телефон] = @Телефон, [Должность] = @Должность, [Оклад] = @Оклад WHERE (([Код сотрудника] = @Original_Код_сотрудника) AND ([ФИО] = @Original_ФИО) AND ([Код отделения] = @Original_Код_отделения) AND ([Дата рождения] = @Original_Дата_рождения) AND ((@IsNull_Телефон = 1 AND [Телефон] IS NULL) OR ([Телефон] = @Original_Телефон)) AND ([Должность] = @Original_Должность) AND ((@IsNull_Оклад = 1 AND [Оклад] IS NULL) OR ([Оклад] = @Original_Оклад)));
SELECT [Код сотрудника], ФИО, [Код отделения], [Дата рождения], Телефон, Должность, Оклад FROM Персонал WHERE ([Код сотрудника] = @Код_сотрудника)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Код сотрудника], ФИО, [Код отделения], [Дата рождения], Телефон, Должност" +
                "ь, Оклад FROM dbo.Персонал";
        ...
        public virtual int Fill(Database1DataSet3.ПерсоналDataTable dataTable) {
        ...
        public virtual Database1DataSet3.ПерсоналDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.ПерсоналDataTable dataTable = new Database1DataSet3.ПерсоналDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.ПерсоналDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код_сотрудника, string Original_ФИО, int Original_Код_отделения, System.DateTime Original_Дата_рождения, string Original_Телефон, string Original_Должность, global::System.Nullable<decimal> Original_Оклад) {
        ...
        public virtual int Insert(int Код_сотрудника, string ФИО, int Код_отделения, System.DateTime Дата_рождения, string Телефон, string Должность, global::System.Nullable<decimal> Оклад) {
        ...
        public virtual int Update(int Код_сотрудника, string ФИО, int Код_отделения, System.DateTime Дата_рождения, string Телефон, string Должность, global::System.Nullable<decimal> Оклад, int Original_Код_сотрудника, string Original_ФИО, int Original_Код_отделения, System.DateTime Original_Дата_рождения, string Original_Телефон, string Original_Должность, global::System.Nullable<decimal> Original_Оклад) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, int Код_отделения, System.DateTime Дата_рождения, string Телефон, string Должность, global::System.Nullable<decimal> Оклад, int Original_Код_сотрудника, string Original_ФИО, int Original_Код_отделения, System.DateTime Original_Дата_рождения, string Original_Телефон, string Original_Должность, global::System.Nullable<decimal> Original_Оклад) {
            return this.Update(Original_Код_сотрудника, ФИО, Код_отделения, Дата_рождения, Телефон, Должность, Оклад, Original_Код_сотрудника, Original_ФИО, Original_Код_отделения, Original_Дата_рождения, Original_Телефон, Original_Должность, Original_Оклад);
        }
    }
